...
const CONTENT: Record<string, { title: string; body: string }> = {
  ...
  support: {
    ...
    body: 'اگر سؤال، پیشنهاد یا مشکلی داشتید خوشحال می‌شویم بشنویم. از طریق ایمیل support@joft.app با ما در ارتباط باشید. تیم «جفتیما» در سریع‌ترین زمان ممکن پاسخ‌گوست.',
  },
  about: {
    title: 'دربارهٔ جفتیما',
    body: '«جفتیما» اپلیکیشنی است برای نزدیک‌تر کردن زوج‌ها؛ با سؤال‌های روزانه، بازی‌های دونفره، مراقبت و چرخه، ثبت خاطره‌ها و یادآوری لحظه‌های عاشقانه. ساخته‌شده با ❤️ برای فارسی‌زبانان.\n\nنسخهٔ ۱.۰.۰',
  },
};
